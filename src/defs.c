...
ASTNode *Node_id(NodeTag tag, Loc loc, ASTNode *scope, char *id) {
    ASTNode *node = malloc(sizeof(ASTNode));
...
ASTNode *Node_pro_id(Loc loc, ASTNode *scope, char *id) { return Node_id(NT_PROID, loc, scope, id); }
ASTNode *Node_com_id(Loc loc, ASTNode *scope, char *id) { return Node_id(NT_COMID, loc, scope, id); }
ASTNode *Node_sym_id(Loc loc, ASTNode *scope, char *id) { return Node_id(NT_SYMID, loc, scope, id); }
...
ASTNode *Node_type_decl(Loc loc, char *id, List *params) {
    ASTNode *id_ = Node_pro_id(loc, NULL, id);
    return Node_type(NT_VAR_TYPE, loc, NULL, id_, params);
}
